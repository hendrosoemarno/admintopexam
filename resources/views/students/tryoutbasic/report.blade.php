...
@section('title', 'Rapor Try Out TKA Basic')

@section('content')
<div class="max-w-3xl mx-auto bg-white shadow rounded-lg p-6">

    <h2 class="text-xl font-bold mb-4">
        TKA SIAP Basic – HASIL {{ strtoupper($result->firstname) }} {{ strtoupper($result->lastname) }}
    </h2>

    <p><strong>Course:</strong> {{ $result->course }}</p>
    <p class="mb-4"><strong>Tanggal Ujian:</strong> {{ $result->tanggal }}</p>
