...
@section('title', 'Data Try Out Siswa Lengkap')
...
@section('content')
    <div x-data="tryoutTable()" class="space-y-6">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <!-- Date Filter Form -->
            <form method="GET" action="{{ route('students.tryout_complete') }}"
                        ...
                        <template x-for="row in filteredData" :key="row.quizattemptsid">
                            <tr class="hover:bg-blue-50 transition duration-150 ease-in-out">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                    <a :href="`{{ url('/students/tryoutbasic') }}/${row.quizattemptsid}`" target="_blank"
