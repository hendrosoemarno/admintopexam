...
@section('title', 'TKA SIAP QUICK')

@section('content')
<h2 class="text-2xl font-semibold mb-4">TKA SIAP QUICK</h2>

@if (empty($data))
    <p class="text-gray-600">Belum ada siswa yang mengikuti TKA SIAP QUICK.</p>
@else
    ...
    <tbody>
        ...
        <tr class="border-b hover:bg-gray-50 text-sm">
            ...
            <td class="py-2 px-3 text-center">
                <a href="{{ route('students.tryoutquick.report', $d->quizattemptsid) }}"
